    ...
    >
      <div className="max-w-6xl mx-auto px-4">
        <div className="mb-12">
          <Link
            to="/"
            className="flex items-center gap-2 text-sage-light/70 hover:text-sage-light mb-6 transition-colors cursor-pointer w-fit"
          >
